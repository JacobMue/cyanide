						...
						<div class="product">
						  ...
						  <div class="product_price">
								...
								<button class="button1">
									<a class="product_link" href="viewProduct.php?category=Men"><span>Shop Now</span></a>
								</button>
		                  </div>
						 <div class="clearfix"></div>
				     </div>
				     <div class="product">
						   <div class="product-desc">
		                       ...
		                       <div class="prod1-desc">
		                           ...
		                           <p class="product_descr">Shop a great selection of Women's Skirts here. Find designer Skirts for Women up to 70% off and get free shipping on orders over KES.5800.</p>							   </div>
							   <div class="clearfix"></div>
					      </div>
						  <div class="product_price">
								<span class="price-access">KES. 800</span>								
									<button class="button1">
									<a class="product_link" href="viewProduct.php?category=Women">
										<span>Shop Now</span>
									</a>
								</button>
		                  </div>
